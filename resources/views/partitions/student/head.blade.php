...
<!--JS MAIN -->
<script src="{{ asset('student/js/jquery-2.2.4.min.js') }}"></script>
<script src="{{ asset('student/js/all.min.js') }}"></script>
<!-- CSS MAIN-->


<link rel="stylesheet" href="{{ asset('student/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('student/css/base.css') }}">
<link rel="stylesheet" href="{{ asset('student/css/top.css') }}">
<link rel="stylesheet" href="{{ asset('student/css/content.css') }}">
