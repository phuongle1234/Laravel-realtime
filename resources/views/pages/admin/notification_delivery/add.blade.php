                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                       ...
                       <!-- old('start_at') -->
                          <input class="form-control" name="start_at" type="text" id="datetime" value="{{ date('Y-m-d H:i') }}" >
                          <!-- placeholder="2022年4月6日" -->
                        </div>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <th>タイトル</th>
                      <td>
                        <input class="form-control" type="text" name="title" value="{{ old('title') }}" placeholder="誰でもわかる三角関数" maxlength="100">
                      </td>
                    </tr>
                    <tr>
                      <th>詳細</th>
                      <td>
                        <textarea class="form-control" name="content" cols="30" rows="6" value="{{ old('content') }}" maxlength="1000">{{ old('content') }}</textarea>
                      </td>
                    </tr>
                    <tr>
                      <th>お知らせ先</th>
                      <td>
                        <div class="choose-subject" id="destination" >
                          <div class="item {{ old('destination') == 'all' || !old('destination') ? 'active' : null  }}" data-id="all" >すべての会員に公開</div>
                          <div class="item {{ old('destination') == 'teacher' ? 'active' : null  }}" data-id="teacher" >講師のみ</div>
                          <div class="item {{ old('student') == 'teacher' ? 'active' : null  }}" data-id="student" >生徒のみ</div>
                        </div>
                      </td>
                    </tr>
                  </tbody>
