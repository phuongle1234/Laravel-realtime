...
<div class="setting-wrapper">
        ...
        <a class="back-link fsc" href="{{ route('student.setting.payment') }}">
                <img src="{{ asset('student/images/back-icon.svg') }}" alt="{{ trans("common.setting.payment") }}"><span>{{ trans("common.setting.payment_edit") }}</span>
        </a>
          ...
          @method('PUT')
            <div class="setting-body">
                        ...
                        <dl class="noinline">
                          <dt>名義</dt>
                          <dd >
                              <input id="cardName" class="form-control" type="text" name="cardName" value="" placeholder="{{ $_card->name }}">
                          </dd>
                        </dl>
                        <div class="box-csv">
                          <dl class="noinline">
...
var cardNumberElement = elements.create('cardNumber',{placeholder: `**** **** **** ${_cardNumber}` });
    cardNumberElement.mount('#cardNumber');

var cardExpiryElement = elements.create('cardExpiry',{placeholder: `${_cardExpiry}` });
