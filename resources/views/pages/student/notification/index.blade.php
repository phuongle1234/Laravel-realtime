...
@php
  $_notifications = Auth::guard('student')->user()->notifications()->where('via','broadcast')->get();
  $id = isset($id) ? $id : null;
          ...
          <ul class="scroll-nonedefault">
              @foreach($_notifications as $_noti)
                    <li class="{{ ! $_noti->read_at ? 'noread' : null }} {{ $_noti->id == $id ? 'class=active' : null }} " >
                        <a href="{{ route('student.notification.show',['id' => $_noti->id]) }}">
                            <div class="mess-ins">
                                  <div class="title">
                                  ...
                                  <div class="content">
                                  <div class="text">{!! $_noti->content !!} </div>
                                  </div>
                              </div>
                          </a>
                    </li>
              @endforeach
                ...
                <div class="dissp">
                  <div class="back-link fsc"> <a href="{{ route('student.notification.index') }}"> <img src="{{ asset('student/images/back-icon.svg') }}" alt="メッセージ"><span>メッセージ</span> </a></div>
                </div>
