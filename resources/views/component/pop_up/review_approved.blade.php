                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <div class="fce btn-pp">
                        ...
                        <a class="btn btn-image btn-message" href="{{ route('student.message') }}">
                            <img src="{{ asset('student/common_img/icon-comment.svg') }}" alt="メッセージを送る"><span>メッセージを送る</span>
                        </a>
                        <input type="hidden" name="request_id" value="{{ $item->id}}" >
                        <button class="btn btn-primary btn-pink" onclick="requestConfirmPp(this)" data-bs-dismiss="modal" aria-hidden="true" >依頼を終了する</button>
                      </div>
                    </div>
