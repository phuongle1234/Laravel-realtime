...
(function(root, factory) {
    ...
    */
    ...
    var defaults = {
        ...
        // api_web: window.location.origin + '/videoHandle',
        name: 'Default name',
    ...
    */
    ...
    me.prototype.upload = function() {
        ...
        let token_csr = document.getElementsByName("csrf-token")[0].getAttribute('content');

        var xhr = new XMLHttpRequest()
        xhr.open( 'PUT' , window.location.origin + '/tokenHandle', true)
        // xhr.setRequestHeader('Authorization', 'Bearer ' + this.token)
        // xhr.setRequestHeader('Content-Type', 'application/offset+octet-stream')
        // xhr.setRequestHeader('Accept', 'application/vnd.vimeo.*+json;version=3.4')

        xhr.setRequestHeader('Content-Type', 'application/json')
        xhr.setRequestHeader('X-CSRF-TOKEN', token_csr)
        ...
        xhr.onload = function(e) {
            ...
            if (e.target.status < 400) {
                ...
                this.video_id_vimeo = response.uri.replace('/videos/', '')
                this.base_link = response.pictures.base_link
                this.player_embed_url =  response.player_embed_url;
                this.transcode = response.transcode.status;
    ...
    // edit video vimeo
    me.prototype.edit = function() {

        var xhr = new XMLHttpRequest()

        //console.log(this.video_id_vimeo,'test abc 456')
        //xhr.open('DELETE', this.complete_url, true)

        xhr.open('PATCH', `https://api.vimeo.com/videos/${this.video_id}`, true)
    ...
    me.prototype.sendFile_ = function() {
        ...
        xhr.onload = (e) => {
            ...
            if(e.target.status < 400 )
                this.onComplete(this.video_id_vimeo );
            else
              this.onUploadError_(e);
        }
        ...
        xhr.onerror = (e) => {
            console.log(e);
            this.onUploadError_(e);
            // this.onContentUploadError_.bind(this);
        }
    ...
    me.prototype.complete_ = function(xhr) {
        ...
        //renema name and description
        var xhr = new XMLHttpRequest()

        //console.log(this.video_id_vimeo,'test abc 456')
        //xhr.open('DELETE', this.complete_url, true)

        xhr.open('PATCH', `https://api.vimeo.com/videos/${this.video_id_vimeo}`, true)
